...
@ app.route('/usuario')
def usuario():
    return render_template('usuario_view/usuario.html')
...
def cadastrarUsuario():
    return render_template('usuario_view/cadastroUsuario.html')
...
def listaUsuario():
    ...
    return render_template('usuario_view/listaUsuario.html', usuarios=usuarios)
...
def atualizarUsuario(id):
    ...
    return render_template('usuario_view/atualizarUsuario.html', usuario=usuario)
...
class Produto(db.Model):
   ...
   # fornecimento = db.relationship(
    #   'Fornecedor', secondary=fornece, backref=db.backref('fornecendo', lazy='dynamic'))
...
def produtoPage():
    return render_template('produto_view/produto.html')
...
def cadastrarProdutos():
    return render_template('produto_view/cadastroProdutos.html')
...
def listarProdutos():
    ...
    return render_template('produto_view/listaProdutos.html', produtos=produtos)
...
def atualizarProdutos(codProduto):
    ...
    return render_template('produto_view/atualizarProdutos.html', produto=produto)
...
def fornecedorPage():
    return render_template('fornecedor_view/fornecedor.html')
...
def cadastrarFornecedores():
    return render_template('fornecedor_view/cadastroFornecedores.html')
...
def listarFornecedores():
    ...
    return render_template('fornecedor_view/listaFornecedores.html', fornecedores=fornecedores)
...
def atualizarFornecedores(codFornecedor):
    ...
    return render_template('fornecedor_view/atualizarFornecedores.html', fornecedor=fornecedor)
...
@app.route('/vendaPage')
def vendaPage():
    return render_template('venda_view/venda.html')
...
def cadastrarVendas():
    return render_template('venda_view/cadastroVendas.html')
...
def listarVendas():
    ...
    return render_template('venda_view/listaVendas.html', vendas=vendas)
...
def atualizarVendas(codVenda):
    ...
    return render_template('venda_view/atualizarVendas.html', venda=venda)
...
if __name__ == '__main__':
    app.secret_key = '66B583C02927EAE9E03D8CA5D9BC90C11DB27C1CEC3B3CBB75A276E96DF89965'
    app.run(debug=True)
